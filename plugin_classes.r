...
coded_key_keywords_2 <- as.data.table(rbind( data.frame("feat"=character(), "rbasic"=numeric(), "rbiophys"=numeric(), "popvol"=numeric(), "popforce"=numeric(), "rprevent"=numeric(), "rexternal"=numeric(), "rhetero"=numeric(), "rincntv"=numeric(), "rinst"=numeric(), "rtech"=numeric(), "rspat"=numeric(), "rsoccap"=numeric(), "rleader"=numeric(), "rinfopred"=numeric())
 ...
 ,asdf(feat='whitelistplugin',rbasic=0, rbiophys=0, popvol=0, popforce=1, rprevent=0, rexternal=0, rhetero=0, rincntv=0, rinst=1, rtech=0, rspat=0, rsoccap=0, rleader=0, rinfopred=0)
 ,asdf(feat='whitelistdesc',rbasic=0, rbiophys=0, popvol=0, popforce=1, rprevent=0, rexternal=0, rhetero=0, rincntv=0, rinst=1, rtech=0, rspat=0, rsoccap=0, rleader=0, rinfopred=0)
 ,asdf(feat='whitelisteddesc',rbasic=0, rbiophys=0, popvol=0, popforce=1, rprevent=0, rexternal=0, rhetero=0, rincntv=0, rinst=1, rtech=0, rspat=0, rsoccap=0, rleader=0, rinfopred=0)
...
coded_key_keywords_2[,rnorms:=0]
coded_key_keywords_2 <- rbind(coded_key_keywords_2, data.table(feat=juicy_words,rbasic=0, rbiophys=0, popvol=0, popforce=0, rprevent=0, rexternal=0, rhetero=0, rincntv=0, rinst=0, rtech=0, rspat=0, rsoccap=0, rleader=0, rinfopred=0, rnorms=1))

### more modeling, exploratory
coded_key_keywords <- as.data.table(rbind( 
...
#,asdf(feat='griefprevention',        inst_type=4, inst_selection=3, boundary=0, action_other_up=0, action_other_down=1, action_admin=0, role_rank=0, role_type=0, economy=0, communication=0)
 ...
 ,asdf(feat='legitimate',             inst_type=0, inst_selection=0, boundary=0, action_other_up=0, action_other_down=0, action_admin=1, role_rank=0, role_type=0, economy=0, communication=0)
 ...
 ,asdf(feat='amplified',              inst_type=0, inst_selection=0, boundary=0, action_other_up=0, action_other_down=0, action_admin=0, role_rank=0, role_type=0, economy=0, communication=0)
#,asdf(feat='worldborder',            inst_type=0, inst_selection=3, boundary=0, action_other_up=0, action_other_down=1, action_admin=1, role_rank=0, role_type=0, economy=0, communication=0)
#,asdf(feat='lwc',                    inst_type=4, inst_selection=3, boundary=0, action_other_up=0, action_other_down=1, action_admin=0, role_rank=0, role_type=0, economy=0, communication=0)
...
coded_key_keywords[,inst_type:=     factor(inst_type, levels=0:4, labels=c( "N/A", "Strategy", "Norm", "Rule", "No discretion"))]
coded_key_keywords[,inst_selection:=factor(inst_selection, levels=0:3, labels=c( "N/A", "Self-selection", "Manual", "Automatic"))]

friv_coded_key_keywords <- as.data.table(rbind(
...
friv_coded_key_keywords[,rnorms:=0]
friv_coded_key_keywords <- rbind(friv_coded_key_keywords, data.table(feat=c("fly", 'hidestream', 'bedhome', 'choptree', 'choptree3', 'nicknamer', 'wirelessredstone'),rbasic=0, rbiophys=0, popvol=0, popforce=0, rprevent=0, rexternal=0, rhetero=0, rincntv=0, rinst=0, rtech=0, rspat=0, rsoccap=0, rleader=0, rinfopred=0, rnorms=1))
